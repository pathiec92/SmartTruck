...
class FireReportService:
    def __init__(self,truckId = "", start = 0, end = 0):
    ...
    def getTruckIds(self, doc_snapshot, changes, read_time):
        ...
        #    c+=1
           ...
           self.getLoads(truckId)

    def getLoads(self, truckId):
    ...
    def getLoadIds(self, doc_snapshot, changes, read_time):
        ...
        #    c+=1
           ...
           ended = doc.to_dict().get("ended")
           print(u'Ended = {}'.format(ended))
    ...
    def getLoadEvents(self, doc_snapshot, changes, read_time):
        # c = 0
        print(u'getLoadEvents start={}, end={}'.format(self.start, self.end))
        ...
        #    c+=1
           ...
           if loadId in self.localLoadIdDic:
               self.localLoadIdDic[loadId].loadEvent.append(u'type={}, msg={}'.format(type, msg))
    ...
    def getVideoLinks(self, doc_snapshot, changes, read_time):
        ...
        #    c+=1
           ...
           self.localLoadIdDic[loadId].videoEvent.append(u'vLink={}, truckId={}'.format(vLink, truckId))

...
class Gcloud:
    ...
    def uploadLogEvent(self,fileNames:[],logId):
        ...
        for name in fileNames :
            links.append("https://firebasestorage.googleapis.com/v0/b/mycloudstorage-1135.appspot.com/o/logs%2F{}%2F{}?alt=media&token={}".format(self.fservice.configs.truckId,name,logId))

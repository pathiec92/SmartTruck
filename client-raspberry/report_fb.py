...
class FireReportService:
    ...
    def launchProcess(self, truckId):
        ...
        cm = u'cd ~/Desktop/Private/Work/SmartTruck/client-raspberry; python3 report_pull_for_id.py -id {} -s {} -e {} >>./rlogs/{}.txt &'.format(truckId,str(int(self.start)),str(int(self.end)),truckId)
